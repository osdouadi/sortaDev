...
export default function Header() {
  return (
    <>
      <div className="header mb-7 lg:mb-0 z-10 bg-[rgb(55,60,66)]/90 drop-shadow-lg fixed top-0 left-0 right-0 w-full">
      ...
      <ul className="mobile-social fixed flex flex-col gap-4  bottom-[24vh] left-2 z-[999999] py-3 lg:hidden">
        {socialMedia.map((item, i) => (
          <li key={i} className="list-icon">
            <Link href={item.link}>{item.icon}</Link>
          </li>
