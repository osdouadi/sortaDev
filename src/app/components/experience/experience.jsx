    ...
    <section>
      ...
      <div className="skills-container py-5 flex flex-col items-start px-2 lg:flex-row lg:flex-wrap lg:px-6 ">
        ...
        >
          ...
          <div className="wrapper-experience flex flex-col gap-1 lg:gap-2 mb-5 px-5 lg:px-0">
          ...
          <div className=" wrapper-experience flex flex-col gap-1 lg:gap-2 mb-3 px-5 lg:px-0">
            <div className="flex flex-col items-start text-gray-300">
              <span className="text-[#5fa8a0] flex items-center gap-2 experience-title">
                <LuGraduationCap />
                Bachelor's Degree{' '}
              ...
              <div className="flex flex-row items-center">
                <span className="text-gray-400">Djelfa University</span>
                <span className="ml-2 text-gray-400">2022</span>
              </div>
            </div>
          ...
          <div className="wrapper-experience  flex flex-col gap-2 mb-4 px-5 lg:px-0">
            <div className="flex flex-col items-start text-gray-300 mb-3">
              ...
              <div>
                ...
                <span className="ml-2 text-gray-400">Remote | 6 months</span>
              </div>
            </div>
            <ul className="text-gray-200 experience-description ">
              <li>
              ...
              <li>
                - This application has separate programs like pos and real
                state, archiving etc..
              </li>
              <li>
                - Each program has screens and modules, each client or partner
                may have one or more programs for every company he owns.
              </li>
              <li>
        ...
        <div className="freelance">
          ...
          <div className="projects-container  p-4 flex justify-center items-center flex-wrap gap-12 lg:mx-auto mb-7">
            <motion.div
              className="project-card w-full lg:w-[44%] py-3 text-center bg-[rgb(57,61,68)] mb-4  rounded-md"
              initial={{ opacity: 0.4, y: 100 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
            >
              ...
              <div className="project-image h-[55vw] lg:h-[23vw] overflow-hidden w-full">
                <img
                  src="/images/abak-showcase.png"
                  alt="project"
                  className="block h-[55vw] lg:h-[23vw] overflow-hidden w-full  rounded-sm"
                />
              </div>
              <div className="text-left pt-4 px-4">
                <p className="text-gray-300 tech font-semibold py-1">
              ...
              <div className="project-description px-3">
                ...
                <ul className="project-features text-gray-300 flex flex-col items-start text-left gap-2 leading-7">
                  ...
                  <li>
                    - Order management system that includes making order,
                    receiving the order by the admin and updating their status.
                  </li>
                  <li>
                    - Admin can create, update, delete categories and services
                  </li>
                  <li>
                    - Admin can add projects to the portfolio as well as images
                    to the gallery.
                  </li>
            ...
            >
              ...
              <div className="project-description px-3">
                ...
                <ul className="project-features text-gray-300 flex flex-col items-start text-left gap-2 leading-7">
                  ...
                  <li>- Server-side pagination, filtaration and sorting.</li>
                  <li>
